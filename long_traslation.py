...
# read the language dataaset
df = pd.read_csv(r'c:\Users\LENOVO\AppData\Local\Temp\Rar$DRa13016.16325.rartemp\4th, 5th  - NLP project\MULTIPLE LANGUAGE TRANSLATION\language.csv')
df.dropna(inplace = True)
lang = df['name'].to_list()
langlist = tuple(lang)
langcode = df['iso'].to_list()

# create dictinary of language and 2 letter langcode
...
# functions to decode audio file for download
def get_binary_file_downloader_html(bin_file, file_label='File'):
    with open(bin_file, 'rp') as f:
        data = f.read()
    ...
    try:
        ...
        if choice in speech_langs.values():
            with c2:
                ...
                bin_str = base64.b64decode(audio_bytes).decode()
